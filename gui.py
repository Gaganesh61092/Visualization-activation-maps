...
model=load_model('C:\\Users\\gagan\\Desktop\\Visualization Activation Maps\\Age_Sex_Detection.h5')
...
def Detect(file_path):
    ...
    activations = intermediate_layer.predict(image)
    activation_map = activations[0, :, :, 2]
